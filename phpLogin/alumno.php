...
<body class="img-bg" style="background: url('assets/img/alu_fondo.jpeg') no-repeat center center fixed; background-size: cover;">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    cronometro.addEventListener('mousedown', (e) => {
        isDragging = true;
        offsetX = e.clientX - cronometro.offsetLeft;
        offsetY = e.clientY - cronometro.offsetTop;
        cronometro.style.transition = "none";
    });

    document.addEventListener('mousemove', (e) => {
        if (isDragging) {
            cronometro.style.left = `${e.clientX - offsetX}px`;
            cronometro.style.top = `${e.clientY - offsetY}px`;
        }
    });
